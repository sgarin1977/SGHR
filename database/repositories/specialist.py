            ...
            .where(
                ...
                *self._release_category_conditions(),
                or_(
                    ...
                    func.lower(func.trim(Profession.name_uk)) == normalized_query,
                    func.lower(func.trim(Profession.name_pl)) == normalized_query,
                    func.lower(func.trim(Profession.name_de)) == normalized_query,
                    func.lower(func.trim(Profession.name_nl)) == normalized_query,
            ...
            .where(
                ...
                *self._release_category_conditions(),
                or_(
                    ...
                    func.lower(Profession.name_uk).ilike(like_query),
                    func.lower(Profession.name_pl).ilike(like_query),
                    func.lower(Profession.name_de).ilike(like_query),
                    func.lower(Profession.name_nl).ilike(like_query),
